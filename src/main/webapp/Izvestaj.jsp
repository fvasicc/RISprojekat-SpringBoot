...
<body>
	...
	<ul class="navbar">
		...
		<security:authorize access="hasRole('MANAGER')"> 
			...
			<li><a class="active" href="/Aerodrom/Izvestaj.jsp"><b>Izvestaji</b></a></li>
		</security:authorize>
	...
	<div class="main">
		<form action="/Aerodrom/manager/sveRezervacije.pdf" method="get">
			<strong>Rezervacije za let sa ID-om: </strong><input type="number" name="idLeta" min="1" placeholder="Unesite id leta..." required>
